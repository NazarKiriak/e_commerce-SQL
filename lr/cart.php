...
<a id="pr" href="#"> Shopping Cart Total Price: UAH <?php totalPrice(); ?>, Total Items <?php item(); ?></a>
</div>
         ...
         <tbody>
          ...
          while ($row=mysqli_fetch_array($run_cart)) {
           ...
           <tr>
             ...
             <td>UAH <?php echo $p_price ?></td>
             <td><?php echo $pro_size ?></td>
             <td><input type="checkbox" name="remove[]" value="<?php echo $pro_id ?>"></td>
             <td>UAH <?php echo $sub_total ?></td>
           </tr>
           <?php } } ?>
        </tfoot>
       </table>
